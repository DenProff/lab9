...
namespace DisciplineTestProject
{
    ...
    public class DisciplineTests
    {
        ...
        [TestMethod]
        public void DisciplineContactHoursExceptionTest()
        {
        ...
        public void DisciplineOverflowExceptionTest()
        {
            ...
            {
                Discipline discipline1 = new Discipline("Test1", 2147483647, 9999);
        ...
        {
            // Arrange
            Discipline discipline = new Discipline("Math", 935, 9);
            string expectedString = "\nДисциплина: Math, часы аудиторной работы: 935, часы самостоятельной работы: 9";
        ...
        {
            // Arrange
            Discipline discipline = new Discipline("Test", 11, 3232323);
        ...
        {
            // Arrange
            Discipline firstDiscipline = new Discipline("Test", 163, 526);
            Discipline secondDiscipline = new Discipline("Test", 123, 53454);
        ...
        public void DisciplineCountTest()
        {
            ...
            // Act
            Discipline firstDiscipline = new Discipline("Test", 1, 2);
